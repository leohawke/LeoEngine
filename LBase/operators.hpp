...
namespace leo
{
	...
	*/
	...
	namespace dep_ops
	{
		...
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using less_than_comparable = _t<details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, index_sequence<2, 4, 1>, index_sequence<0, 1, 2, 3, 4, 5>>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using equality_comparable = _t<details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, index_sequence<7>, index_sequence<6, 7, 8>>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using equivalent = _t<details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, index_sequence<10>, index_sequence<9>>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using partially_ordered = _t<details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, index_sequence<2, 11, 14>, index_sequence<11, 12, 2, 3, 13, 14>>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using addable = _t< details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, details::ops_bin_id_seq<0, 0, 1>, details::ops_bin_id_seq<0, 0, 1, 2, 3>>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using subtractable = _t<details::ops_seq<_type, _type2, _tOpt, details::ops_bin_id_seq<1, 0, 1>>>; template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using subtractable_left = _t<details::ops_seq<_type, _type2, _tOpt, details::ops_bin_id_seq<1, 4, 5>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using multipliable = _t< details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, details::ops_bin_id_seq<2, 0, 1>, details::ops_bin_id_seq<2, 0, 1, 2, 3>>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using dividable = _t<details::ops_seq<_type, _type2, _tOpt, details::ops_bin_id_seq<3, 0, 1>>>; template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using dividable_left = _t<details::ops_seq<_type, _type2, _tOpt, details::ops_bin_id_seq<3, 4, 5>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using modable = _t<details::ops_seq<_type, _type2, _tOpt, details::ops_bin_id_seq<4, 0, 1>>>; template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using modable_left = _t<details::ops_seq<_type, _type2, _tOpt, details::ops_bin_id_seq<4, 4, 5>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using left_shiftable = _t<details::ops_seq<_type, _type2, _tOpt, details::ops_bin_id_seq<5, 0, 1>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using right_shiftable = _t<details::ops_seq<_type, _type2, _tOpt, details::ops_bin_id_seq<6, 0, 1>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using xorable = _t< details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, details::ops_bin_id_seq<7, 0, 1>, details::ops_bin_id_seq<7, 0, 1, 2, 3>>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using andable = _t< details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, details::ops_bin_id_seq<8, 0, 1>, details::ops_bin_id_seq<8, 0, 1, 2, 3>>>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using orable = _t< details::ops_seq<_type, _type2, _tOpt, cond_t<is_same<_type, _type2>, details::ops_bin_id_seq<9, 0, 1>, details::ops_bin_id_seq<9, 0, 1, 2, 3>>>>;
		...
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using totally_ordered = details::flat_ops<_type, _type2, _tOpt, less_than_comparable, equality_comparable>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using additive = details::flat_ops<_type, _type2, _tOpt, addable, subtractable>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using multiplicative = details::flat_ops<_type, _type2, _tOpt, multipliable, dividable>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using integer_multiplicative = details::flat_ops<_type, _type2, _tOpt, multiplicative, modable>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using arithmetic = details::flat_ops<_type, _type2, _tOpt, additive, multiplicative>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using integer_arithmetic = details::flat_ops<_type, _type2, _tOpt, additive, integer_multiplicative>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using bitwise = details::flat_ops<_type, _type2, _tOpt, xorable, andable, orable>;
		template<class _type, class _tOpt = use_constfn>
		using unit_steppable
			= details::ebases<incrementable<_type>, decrementable<_type>>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using shiftable = details::flat_ops<_type, _type2, _tOpt, left_shiftable, right_shiftable>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using ring_operators = details::flat_ops<_type, _type2, _tOpt, additive, subtractable_left, multipliable>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using ordered_ring_operators = details::flat_ops<_type, _type2, _tOpt, ring_operators, totally_ordered>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using field_operators = details::flat_ops<_type, _type2, _tOpt, ring_operators, dividable, dividable_left>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using ordered_field_operators = details::flat_ops<_type, _type2, _tOpt, field_operators, totally_ordered>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using euclidean_ring_operators = details::flat_ops<_type, _type2, _tOpt, ring_operators, dividable, dividable_left, modable, modable_left>;
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using ordered_euclidean_ring_operators = details::flat_ops<_type, _type2, _tOpt, totally_ordered, euclidean_ring_operators>;
		template<class _type, typename _type2, class _tOpt = use_constfn> using input_iteratable = details::ebases< equality_comparable<_type, _type, _tOpt>, incrementable<_type>, dereferenceable<_type, _type2, _tOpt >>;
		template<class _type, typename _type2, class _tOpt = use_constfn> using output_iteratable = details::ebases<incrementable<_type>>;
		template<class _type, typename _type2, class _tOpt = use_constfn> using forward_iteratable = details::ebases<input_iteratable<_type, _type2, _tOpt>>;
		template<class _type, typename _type2, class _tOpt = use_constfn> using bidirectional_iteratable = details::ebases< forward_iteratable<_type, _type2, _tOpt>, decrementable<_type >>;
		...
		\todo 实现调整选项。
		*/
		template<class _type, typename _type2 = _type, class _tOpt = use_constfn> using operators = details::flat_ops<_type, _type2, _tOpt, totally_ordered, integer_arithmetic, bitwise>;
		//@}
