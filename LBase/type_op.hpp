...
#include "LBase/tuple.hpp"// for is_class, std::declval, is_detected, vseq::apply,
...
#ifdef LB_IMPL_GNUCPP
#	if LB_IMPL_GNUCPP >= 40600
...
#if LB_IMPL_GNUCPP && YB_IMPL_GNUCPP >= 40600
