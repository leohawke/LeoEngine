...
#include "LBase/any_iterator.hpp"
...
namespace CHRLib
{
	...
	{
		return f(lforward(obj),leo::input_monomorphic_iterator(std::ref(i)),
			std::move(st));
	}
	...
	{
		return f(leo::input_monomorphic_iterator(std::ref(i)), std::move(st));
	}
