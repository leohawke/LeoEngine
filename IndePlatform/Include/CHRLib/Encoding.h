#ifndef IndePlatform_CHRLib_Encoding_h
#define IndePlatform_CHRLib_Encoding_h
...
namespace CHRLib
{
	...
	namespace CharSet
	{
		...
		*/
		...
		//! \brief 通用别名。
		constexpr const Encoding US_ASCII(csASCII), SHIFT_JIS(csShiftJIS),
		...
		*/
		...
		//! \brief 其它别名。
		constexpr const Encoding iso_ir_6(US_ASCII), ISO646_US(US_ASCII),
		...
		*/
		...
		{
			static constexpr const ByteOrder byte_order = ByteOrder::unknown;
			using type = char;
		};
		...
		{
			static constexpr const ByteOrder byte_order = ByteOrder::neutral;
			using type = char;
		};
		...
		{
			static const ByteOrder byte_order = ByteOrder::unknown;
			using type = ucs2_t;
		};
		...
		{
			static const ByteOrder byte_order = ByteOrder::big;
		};

		template<>
		struct EncodingTraits<csUTF16LE> : EncodingTraits<csUTF16>
		{
			static const ByteOrder byte_order = ByteOrder::little;
		};
