...
static QUADVertex vertexs[4] = {
	{ float4(+1.f, +1.f, 0.98f, 1.f),float3(0.f,0.f,0.f),float2(1.f,0.f) },
	{ float4(+1.f, -1.f, 0.98f, 1.f),float3(0.f,0.f,0.f),float2(1.f,1.f) },
	{ float4(-1.f, +1.f, 0.98f, 1.f),float3(0.f,0.f,0.f),float2(0.f,0.f) },
	{ float4(-1.f, -1.f, 0.98f, 1.f),float3(0.f,0.f,0.f),float2(0.f,1.f) }
};
